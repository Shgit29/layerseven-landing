...
const project = workItems.find((item) => item.slug === "blocktrack");

export const metadata: Metadata = {
  title: "BlockTrack Technical Case Study | Work",
  description:
    "Product engineering case study showing how LayerSeven designed a blockchain-powered supply chain traceability platform.",
};

export default function BlockTrackTechnicalPage() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="section-shell bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="section-wrap space-y-10">
          ...
          <div className="panel-card">
            <h2 className="text-2xl font-semibold text-slate-950">Core Features</h2>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="panel-card">
              <h2 className="text-2xl font-semibold text-slate-950">Technical Approach</h2>
              <p className="mt-4 text-base leading-8 text-slate-600">
                BlockTrack uses a traditional application database for fast querying
                and business workflows, while blockchain-backed verification is used
                for traceability and tamper-resistance. This avoids putting every
                operational detail directly on-chain while still preserving trust
                where it matters.
              </p>
            </div>
            <div className="panel-card-dark border-white/10">
