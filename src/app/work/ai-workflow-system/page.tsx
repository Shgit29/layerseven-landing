...
const project = workItems.find((item) => item.slug === "ai-workflow-system");

export const metadata: Metadata = {
  title: "AI Workflow System | Work",
  description:
    "AI integration case study covering document search, structured answers, and internal workflow automation.",
};

export default function AiWorkflowSystemPage() {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="section-shell bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="section-wrap space-y-10">
          ...
          <div className="panel-card">
            <h2 className="text-2xl font-semibold text-slate-950">Key Capabilities</h2>
